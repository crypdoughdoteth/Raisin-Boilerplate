    ...
    return (
        <div className="flex flex-col bg-gray-800">
            <div className="navbar bg-base-100">
                ...
                <Link href="/" className="btn btn-ghost normal-case text-xl">Raisin</Link>
            ...
            <div>
                ...
                <div className="carousel h-1/2 w-1/2 m-5">
                    <div id="item1" className="carousel-item w-full">
                        <img src="https://cc0.photo/wp-content/uploads/2022/03/River-flowing-over-stone-stairs-in-sun-980x735.jpg" className="w-full" />
                    </div>
                    <div id="item2" className="carousel-item w-full">
                        <img src="https://cc0.photo/wp-content/uploads/2022/02/New-York-skyline-in-October-2017-980x656.jpg" className="w-full" />
                    </div>
                    <div id="item3" className="carousel-item w-full">
                        <img src="https://cc0.photo/wp-content/uploads/2017/03/Guy-painting-on-John-Lennon-wall-980x656.jpg" className="w-full" />
                    </div>
                    <div id="item4" className="carousel-item w-full">
                        <img src="https://cc0.photo/wp-content/uploads/2015/11/Abstract-traffic-lights-980x651.jpg" className="w-full" />
                    </div>
                </div>
                </div>
            ...
            <div className='flex shadow-xl self-center mt-20 h-2/4 w-2/4'><iframe width="1440" height="620" src="https://www.youtube.com/embed/chMuhzkyfgQ" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe></div>
